...
function setupCircleVideoPlayer(bubble) {
  ...
  const expand = () => {
    ...
    bubble._circleAnchor = { cx: phRect.left + phRect.width / 2, cy: phRect.top + phRect.height / 2 };
  ...
  toTextBtn.addEventListener('click', (e) => {
    e.stopPropagation();
    showToast('Расшифровка голоса в текст скоро появится');
  });
}
